...
abstract contract Ownable is Context {
    ...
    event AdminAdded(address indexed owner, address indexed admin);
    event AdminRemoved(address indexed owner, address indexed admin);
    ...
    function removeAdmin(address _oldAdmin) public onlyOwner {
        require(_admin[_oldAdmin], "wrong admin address");
        _admin[_oldAdmin] = false;
